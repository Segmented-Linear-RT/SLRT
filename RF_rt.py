...
def make_forest(data, B, id_cand_all, id_dis, id_res, labels, max_depth = 500, Nmin = 100, Nsplit = 10,mi = 0.5):
...
#	pairs = data.items()
	for b in range(B):
		...
		trees.append(rt.grow_tree(boot,id_cand_all, id_dis, id_res, index = [1], labels = labels, Nmin = Nmin, Nsplit = Nsplit, max_depth = max_depth, \
